...
{: .box-warning}
**Aviso:** **Recomenda-se** adicionar uma chave SSH na conta do  **<a title="Link do GitHub" href="https://github.com/" target="_blank">GitHub</a>**. Com isso, não será mais necessário digitar o usuário/senha a cada _commit_, ou seja, a cada atualização do repositório. Fiz isso seguindo o procedimento apresentado **<href="https://medium.com/@rgdev/como-adicionar-uma-chave-ssh-na-sua-conta-do-github-linux-e0f19bbc4265." target="_blank">aqui</a>**.
...
git clone git@github.com:michelmetran/michelmetran.github.io.git    # Para uso via SSH (não precisa de usuário e senha)
~~~
...
{: .box-note}
**Nota:** Com isso já foi possível subir um arquivo simples com extensão _.html_. Para _sites_ com maior detalhamento, excluí esse repositório com apenas um arquivo _index.html_ e fiz o **_Fork_** de um _template_, conforme apresento no tópico abaixo, sobre **Meu _site_...**
