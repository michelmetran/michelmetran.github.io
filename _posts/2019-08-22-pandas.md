...
```python
# %load '~/Documents/SourceCode/codes/git/update_github.py'
import os
...
```
    ...
    [master 0d3770b] Initial commit
     2 files changed, 340 insertions(+), 722 deletions(-)
     delete mode 100644 _posts/2019-08-05-pandas.md
     create mode 100644 _posts/2019-08-08-pandas.md
    Counting objects: 4, done.
    Delta compression using up to 4 threads.
    Compressing objects: 100% (4/4), done.
    Writing objects: 100% (4/4), 3.40 KiB | 3.40 MiB/s, done.
    Total 4 (delta 2), reused 0 (delta 0)
    remote: Resolving deltas: 100% (2/2), completed with 2 local objects.[K
    To github.com:michelmetran/michelmetran.github.io.git
       5192a44..0d3770b  master -> master
