...
```
    ...
    b'' b''
    b'[master 842fd6d] Atualizando\n 1 file changed, 3 insertions(+), 3 deletions(-)\n' b''
    b'' b'To github.com:michelmetran/package_pandas.git\n   9a05de7..842fd6d  master -> master\n'
    Done!!
    b'' b''
    b'[master 223442b] Atualizando\n 4 files changed, 22 insertions(+), 71 deletions(-)\n rename img/posts/{big_Folium.png => big_folium.png} (100%)\n create mode 100644 img/posts/big_pandas.png\n create mode 100644 img/posts/icon_pandas.png\n' b''
    b'' b'To github.com:michelmetran/michelmetran.github.io.git\n   707d883..223442b  master -> master\n'
    Done!!
