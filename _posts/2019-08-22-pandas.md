...
{: .box-note}
**Nota:** É possível acessar esse _post_ em <a title="Link do Folium" href="https://github.com/michelmetran/package_pandas/raw/master/docs/pandas.pdf" target="_blank">**formato .pdf**</a> e, ainda, no <a title="Link do Repositório" href="https://github.com/michelmetran/package_pandas" target="_blank">**repositório do GitHub**</a>.
...
O arquivo _.ipynb_ pode ser exportado em formatos diversos. Abaixo carrego uma função que escrevi para facilitar o processo de exportação do arquivo em diferentes locais do PC para, posteriormente, atualizar os repositórios contidos no _GitHub_.

https://github.com/michelmetran
...
```
    ...
    b'' b''
    b'[master 2f8e4e6] Atualizando\n 1 file changed, 1 insertion(+), 1 deletion(-)\n' b''
    b'' b'To github.com:michelmetran/package_pandas.git\n   477c79e..2f8e4e6  master -> master\n'
    Done!!
    b'' b''
