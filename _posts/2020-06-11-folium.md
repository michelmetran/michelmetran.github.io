...
thumbnail-img: /assets/img/posts/folium_icon.png
share-img: /assets/img/posts/folium_big.png
cover-img: /assets/img/posts/folium_big.png
...
```python
[os.makedirs(i, exist_ok=True) for i in ['maps']]
```
